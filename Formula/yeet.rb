class Yeet < Formula
  ...
  homepage "https://github.com/shelfwood/yeet"
  url "https://github.com/shelfwood/yeet/archive/refs/tags/v1.0.0.tar.gz"
  sha256 "TO_BE_GENERATED"  # Will be calculated during release
  license "MIT"
  head "https://github.com/shelfwood/yeet.git", branch: "main"
